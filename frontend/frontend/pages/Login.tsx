    ...
    <div className="min-h-screen bg-[#141412] text-neutral-100 flex justify-center items-center p-4">
      <div className="w-full max-w-md bg-[#1c1c1a] border border-[#2a2a27] rounded-xl p-8 shadow-2xl">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div>
            ...
            <div className="text-right mt-1.5">
              <button
                type="button"
                onClick={() => toast.success('Reset password feature is a mock!')}
                className="text-xs text-[#8a8a84] hover:text-neutral-200 transition-colors cursor-pointer"
              >
                Forgot password?
              </button>
            </div>
        ...
        <div className="mt-6 text-center text-xs text-[#8a8a84]">
          ...
          <Link to="/register" className="text-neutral-200 hover:text-white font-medium underline underline-offset-4 transition-colors">
            Register
          </Link>
        </div>
      </div>
